...
namespace AuctionService {
    ...
    static AuctionsReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "CgoCaWQYASABKAkiWQoQR3JwY0F1Y3Rpb25Nb2RlbBIKCgJpZBgBIAEoCRIO",
            "CgZzZWxsZXIYAiABKAkSEgoKYXVjdGlvbkVuZBgDIAEoCRIVCg1yZXNlcnZl",
            "ZFByaWNlGAQgASgFIjkKE0dycGNBdWN0aW9uUmVzcG9uc2USIgoHYXVjdGlv",
            "bhgBIAEoCzIRLkdycGNBdWN0aW9uTW9kZWwyRQoLR3JwY0F1Y3Rpb24SNgoK",
            "R2V0QXVjdGlvbhISLkdldEF1Y3Rpb25SZXF1ZXN0GhQuR3JwY0F1Y3Rpb25S",
            "ZXNwb25zZUIRqgIOQXVjdGlvblNlcnZpY2ViBnByb3RvMw=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::AuctionService.GrpcAuctionModel), global::AuctionService.GrpcAuctionModel.Parser, new[]{ "Id", "Seller", "AuctionEnd", "ReservedPrice" }, null, null, null, null),
  ...
  #endif
  {
    ...
    public GrpcAuctionModel(GrpcAuctionModel other) : this() {
      ...
      reservedPrice_ = other.reservedPrice_;
      _unknownFields = pb::UnknownFieldSet.Clone(other._unknownFields);
    }
    ...
    /// <summary>Field number for the "reservedPrice" field.</summary>
    public const int ReservedPriceFieldNumber = 4;
    private int reservedPrice_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public int ReservedPrice {
      get { return reservedPrice_; }
      set {
    ...
    public bool Equals(GrpcAuctionModel other) {
      ...
      if (ReservedPrice != other.ReservedPrice) return false;
      return Equals(_unknownFields, other._unknownFields);
    }
    ...
    public override int GetHashCode() {
      ...
      if (ReservedPrice != 0) hash ^= ReservedPrice.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
      return hash;
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (ReservedPrice != 0) {
        ...
        output.WriteInt32(ReservedPrice);
      }
      if (_unknownFields != null) {
        _unknownFields.WriteTo(output);
      }
    ...
    public int CalculateSize() {
      ...
      if (ReservedPrice != 0) {
        size += 1 + pb::CodedOutputStream.ComputeInt32Size(ReservedPrice);
      }
      if (_unknownFields != null) {
        size += _unknownFields.CalculateSize();
      }
    ...
    public void MergeFrom(GrpcAuctionModel other) {
      ...
      if (other.ReservedPrice != 0) {
        ReservedPrice = other.ReservedPrice;
      }
      _unknownFields = pb::UnknownFieldSet.MergeFrom(_unknownFields, other._unknownFields);
    }
